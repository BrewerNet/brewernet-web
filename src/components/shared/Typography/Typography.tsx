...
export const TypographyH1: React.FC<TypographyProps> = ({ children, className }) => {
  const combinedClassName = `font-sans scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl ${className || ''}`
  return <h1 className={combinedClassName}>{children}</h1>
}

export const TypographyH2: React.FC<TypographyProps> = ({ children, className }) => {
  const combinedClassName = `font-sans scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0 ${className || ''}`
  return <h2 className={combinedClassName}>{children}</h2>
}

export const TypographyH3: React.FC<TypographyProps> = ({ children, className }) => {
  const combinedClassName = `font-sans scroll-m-20 text-2xl font-semibold tracking-tight ${className || ''}`
  return <h3 className={combinedClassName}>{children}</h3>
}

export const TypographyH4: React.FC<TypographyProps> = ({ children, className }) => {
  const combinedClassName = `font-sans scroll-m-20 text-xl font-semibold tracking-tight ${className || ''}`
...
export const TypographyParagraph: React.FC<TypographyProps> = ({ children, className }) => {
  const combinedClassName = `font-sans leading-7 [&:not(:first-child)]:mt-6 ${className || ''}`
...
export const TypographySmall: React.FC<TypographyProps> = ({ children, className }) => {
  const combinedClassName = `font-sans text-sm font-medium leading-none ${className || ''}`
