...
export const TypographyParagraph: React.FC<TypographyProps> = ({ children, className }) => {
  const combinedClassName = `leading-7 [&:not(:first-child)]:mt-6 ${className || ''}`
...
export const TypographyCode: React.FC<TypographyProps> = ({ children, className }) => {
  const combinedClassName = `relative rounded bg-muted px-[0.3rem] py-[0.2rem] font-mono text-sm font-semibold ${className || ''}`
...
export const TypographyLead: React.FC<TypographyProps> = ({ children, className }) => {
  const combinedClassName = `text-xl text-muted-foreground ${className || ''}`
  return <p className={combinedClassName}>{children}</p>
}
...
export const TypographySmall: React.FC<TypographyProps> = ({ children, className }) => {
  const combinedClassName = `text-sm font-medium leading-none ${className || ''}`
